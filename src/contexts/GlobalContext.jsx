...
export const GlobalContextProvider = ({ children }) => {
  ...
  const resources = [
    { id: 1800, nome: 'Meet pra vazar a aula de 6/2/26', imagem: '', tipo: 'destaque', categoria: 'Da Casa ', descricao: 'Meet da aula de hoje', link: 'https://meet.google.com/qcg-oihe-uhx', tags: [] },
