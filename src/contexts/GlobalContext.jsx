...
export const GlobalContextProvider = ({ children }) => {
  ...
  const resources = [
    ...
    { id: 20, nome: 'Fabio Akita', imagem: 'https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExMnJ3M2V3eGs5eDF3d3h6aHgzdWhsODAwYXlzZTNjYnY1ZDJia3F0aSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/BTuoZOEfoqAQ8/giphy.gif', tipo: 'normal', categoria: 'Canal', descricao: 'Ciência da computação, tecnologia e puxões de orelha. Canal obrigatório, mesmo que não goste:', link: 'https://www.youtube.com/@Akitando', tags: ['Ciência da Computação', 'Tecnologia', 'Tudo', 'Manja Muito', 'Obrigatório'] },
