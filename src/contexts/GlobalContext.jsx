...
export const GlobalContextProvider = ({ children }) => {
  ...
  const resources = [
    ...
    { id: 185, nome: 'DevRoute', imagem: '', tipo: 'normal', categoria: 'Repositórios', descricao: 'Seu roadmap de estudos para programação — do zero ao deploy. Baita ferramenta massa com conteúdo organizado por trilhas e muito mais. Feito com carinho pelo colega Willer e por quem mais quiser aproveitar para contribuir!', link: 'https://devpath.vercel.app/', tags: ['Links', 'Cursos', 'JamanjoLike'] },
    { id: 186, nome: 'Radar Gamedev', imagem: '', tipo: 'normal', categoria: 'Repositórios', descricao: 'Um Jamanjo para a área de desenvolvimento de jogos! Adorei a ideia! :D Feito com carinho pelo colega João Ricardo!', link: 'https://joaoricardo.dev/radar/', tags: ['Links', 'Cursos', 'JamanjoLike', 'Ferramentas', 'GameDev'] },
    ...
    { id: 146, nome: 'Geraldo Git/GitHub', imagem: '', tipo: 'normal', categoria: 'Da Casa', descricao: 'Documento índice com meus materiais a respeito de Git/GitHub, versionamento e tals...', link: 'https://www.notion.so/rafaellindemann/0003-Geral-do-Git-e-GitHub-19dd393ff68e8096b69ce12ca44d4f7f', tags: ['Git', 'GitHub', 'Colaboração', 'Versionamento', 'MaterialDoRafa'] },
    { id: 147, nome: 'Geralda Lógica e frontend', imagem: '', tipo: 'normal', categoria: 'Da Casa', descricao: 'Documento índice com meus materiais a respeito de Lógica de programação e frontend vanilla', link: 'https://www.notion.so/rafaellindemann/0001-Geral-da-L-gica-e-frontend-vanilla-2d626512d4e849c88aa12597d8f2872c', tags: ['Lógica', 'JS', 'HTML', 'CSS', 'portugol', 'MaterialDoRafa'] },
    ...
    { id: 155, nome: 'Geraldo React', imagem: 'https://i.gifer.com/JXA0.gif', tipo: 'normal', categoria: 'Da Casa', descricao: 'Documento índice com meus materiais sobre React JS', link: 'https://www.notion.so/rafaellindemann/0002-Geral-do-React-JS-e4cf31e0fc1e465190610e0c440571b2', tags: ['React', 'JS', 'CSS', 'MaterialDoRafa'] },
    { id: 156, nome: 'Geraldo Node e Banco de dados', imagem: '', tipo: 'normal', categoria: 'Da Casa', descricao: 'Documento índice com meus materiais sobre Node JS e um pouco de banco de dados PostgreSQL também', link: 'https://www.notion.so/rafaellindemann/0004-Geral-de-Banco-de-Dados-e-NodeJS-883a4ad5f9f449bbabd176ad53ff48c2', tags: ['Node', 'BD', 'PostgreSQL', 'MaterialDoRafa'] },
    ...
    { id: 175, nome: 'Geraldo Java e Orientação a Objetos', imagem: '', tipo: 'normal', categoria: 'Da Casa', descricao: 'Documento índice com meus materiais sobre Java e OO. Não deixe de verificar o documento de referências e saiba mais que tá bem forte!', link: 'https://www.notion.so/rafaellindemann/0037-Geral-do-JAVA-e-POO-674df3bcfbc94b308f5e5a5326196ccc', tags: ['Java', 'OO', 'Objetos', 'MaterialDoRafa'] },
    ...
    { id: 184, nome: 'A Soft Murmur', imagem: '', tipo: 'normal', categoria: 'Balaio', descricao: 'Um ótimo mixer de ruido branco para esquecer o mundo lá fora e se concentrar na programação ou estudo.', link: 'https://asoftmurmur.com/', tags: ['Concentração', 'Saúde Mental', 'Ruído Branco'] },

    { id: 183, nome: '⚠ Senhas no BD e segurança', imagem: '', tipo: 'normal', categoria: 'Balaio', descricao: 'O vídeo do Renato era pra falar de senha no banco de dados mas é uma baita (e obrigatória) aula de segurança! Não deixe de não perder :D', link: 'https://www.youtube.com/watch?v=VW2mywTTz80', tags: ['Segurança', 'Criptografia', 'Hacker', 'Algoritmos'] },
    { id: 180, nome: '⚠ Ser dev em 2026?', imagem: '', tipo: 'normal', categoria: 'Carreira', descricao: 'Excelente vídeo dos fofos do CDF TV explanando se ainda vale a pena ser dev e, mais importante, o que fazer/saber para ser relevante.', link: 'https://www.youtube.com/watch?v=2AnSbALxoD8', tags: ['Carreira'] },
