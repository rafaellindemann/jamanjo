...
export const GlobalContextProvider = ({ children }) => {
  ...
  const resources = [
    ...
    { id: 176, nome: 'falae', imagem: '', tipo: 'normal', categoria: 'Da Casa', descricao: '💚Apenas um lindo formzinho pra deixar voluntariamente tua opinião/critíca/sugestão sobre a aula do tio Rafa :D Toda opinião será sempre muito bem vinda!💚', link: 'https://forms.gle/7CYXm8njXJjb57uq5', tags: ['Pesquisa', 'Opinião', '<3', 'MaterialDoRafa'] },
